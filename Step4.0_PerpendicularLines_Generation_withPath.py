...
sword_nodes_gdf = gpd.read_file(r"/Users/ychen223/Documents/RiverSlope/Dataset/SWOTRiverDatabase_SWORD/SWORD_v16_gpkg/na_sword_nodes_v16.gpkg", layer = "nodes")
...
## Step 4: Save to shapefile or visualize (if it reports a Nan or None geometries error, run Step 5)
output_path = r"/Volumes/MacOS/UA/Dataset/Match_FIMhydrofabric45211_SWORD/Shapefile/perpendicular_lines_len006_space_sword_nodes_TEST.shp"

perp_gdf.to_file(output_path, driver='ESRI Shapefile')
...
output_path = r"/Volumes/MacOS/UA/Dataset/Match_FIMhydrofabric45211_SWORD/Shapefile/perpendicular_lines_len006_space_sword_nodes_TEST_cleaned.shp"
